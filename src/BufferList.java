/** Source code example adapted from "A Practical Introduction to Data
 *Structures and Algorithm Analysis, 3rd Edition (Java)" 
 *by Clifford A. Shaffer
 *Copyright 2008-2011 by Clifford A. Shaffer
 *
 *Adapted ArrayList source code to fit the needs of
 *A list of buffers.
 *
 *@author sshumway
 *@author sohyun
...
class BufferList<E> 
{
     ...
     * 
     * @param max The number of buffers that can
     * be held in the buffer pool.
     */
    ...
    /**
     * Moves buffer from position to the front of the list
     * to be reused. Follows LRU buffer pool principle.
     * 
     * @param itPos Position of buffer to promote to front.
